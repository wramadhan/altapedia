...
const Switchpage = ({ prevPage, nextPage, page }) => {
  return (
    <div className="flex justify-end mb-44 mt-16">
      <button onClick={prevPage} className="w-8 h-8  rounded bg-[#FEF3EB] place-content-center grid content-center">
      ...
      <input
        ...
        value={page}
      />
      <button onClick={nextPage} className="w-8 h-8 rounded h-4 bg-[#FEF3EB] place-content-center grid content-center">
