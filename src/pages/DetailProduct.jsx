...
const DetailProduct = () => {
  ...
  const detailProduct = () => {
    ...
    var config = {
      method: 'get',
      url: 'http://35.162.202.237:80/product/5',
      headers: {
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdXRob3JpemVkIjp0cnVlLCJleHAiOjE2NjMzMzg5NDUsInVzZXJJZCI6Nn0.GUz60DNaS7xnUrMjkq2Wa4i4Hn-qepVIk8zjWeTyGos'
      }
    };
  ...
  return (
    <div>
      ...
      <div className="sm:flex">
        ...
        <div className="w-auto mt-8 ml-3 mb-4 sm:w-9/12 md:mt-10 md:mb-10 lg:mt-20 lg:ml-20 lg:w-[578px]">
          ...
          <h5 className="md:text-lg lg:text-xl text-[#1B345F] font-medium mb-3.5">Product Descriptions</h5>
          <p className=" md:text-base lg:text-lg text-[#1B345F] ">
