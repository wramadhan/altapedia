      ...
      <div className="mb-44">
        ...
        <div className="md:flex md:justify-around sm:mr-4 ">
          <div className=" mx-4">
            ...
            <input className="w-full h-10 sm:w-[522px] sm:h-14 border border-[#DBE5FA] rounded-lg" onChange={editName} />
            ...
            <textarea className="w-full h-36  sm:w-[522px] sm:h-[242px] border border-[#DBE5FA] rounded-lg p-2" onChange={editDescription} name="" id=""></textarea>
            ...
            <input className="w-full h-10 sm:w-[522px] sm:h-14 border border-[#DBE5FA] rounded-lg pl-2" type="number" placeholder="Enter Price" onChange={editPrice} />
            <p className="text-xs text-[#CCCCCC] mb-8">Set the minimum amount to buy for this product</p>
          </div>
          <div className="ml-4">
            <h3 className="text-xl font-medium text-[#1B345F] mb-6 text-center sm:text-left">Product Images</h3>
            <div className="flex justify-center">
              <div className='border-dotted border-slate-600/50 w-[320px] h-[320px] border-[3px]' style={{ backgroundImage: `url(${image})` }}>
                <input type="file" className="w-full h-full" onChange={editFoto} />
              </div>
            </div>
            <br />
            <div className="flex justify-center">
              <button className="bg-[#FEF3EB] text-xl rounded-lg w-40 h-14 mr-6" onClick={() => toMyProduct()}>Cancel</button>
              <button className="bg-[#F7731C] text-xl w-40 h-14 rounded-lg" onClick={() => handleEditProduct()}>Save</button>
            </div>
          </div>
        </div>
      </div>
